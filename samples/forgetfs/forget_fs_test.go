...
func TestForgetFS(t *testing.T) { ogletest.RunTests(t) }
...
func init() { ogletest.RegisterTestSuite(&ForgetFSTest{}) }

func (t *ForgetFSTest) SetUp(ti *ogletest.TestInfo) {
...
func (t *ForgetFSTest) Stat_Foo() {
	...
	ogletest.AssertEq(nil, err)
	ogletest.AssertEq("foo", fi.Name())
	ogletest.AssertEq(os.FileMode(0777), fi.Mode())
}
